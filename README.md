...
- **Tests** : pytest (backend, 107 tests) + Vitest (frontend, 16 tests) — CI GitHub Actions
...
L'app n'affiche que ce que les collecteurs ont chargé. Selon la configuration :

| Source | Couverture | Prérequis |
|---|---|---|
